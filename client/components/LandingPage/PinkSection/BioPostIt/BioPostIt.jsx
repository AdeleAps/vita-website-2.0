...
const BioPostIt = () => {
  return (
    <section className={styles.bioNote}>
      <div>
        <img src="./images/bio.jpeg" alt="Vita Apsīte" />
      </div>
      <div>
        <div>
          <p>
            ...
            konsultēšanā esmu izmantojusi visu laiku. Tagad strādāju
            privātpraksē ar individuāliem klientiem un ģimenēm.
          </p>
          <p>
            ...
            dažkārt asarām, piedošanu, pieņemšanu, saprašanu un jaunām
            atklāsmēm."
          </p>
        </div>
